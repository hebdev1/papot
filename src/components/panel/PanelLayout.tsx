          ...
          <NavLink
            ...
            className={({ isActive }) =>
              ...
              `flex h-11 items-center rounded-xl transition-colors ${
                isActive
                  ? "bg-[#D6F0FB] font-semibold text-[#002089]"
                  : "text-[#7a6355] hover:bg-[#E9F9FE] hover:text-[#002089]"
              }`
            }
          >
      ...
      <div className="space-y-1 border-t border-[#e2d5c3] p-2">
        {[
          ...
          <NavLink
            ...
            to={to}
            title={open ? undefined : label}
            className="flex h-10 items-center rounded-xl text-[#7a6355] transition-colors hover:bg-[#E9F9FE] hover:text-[#002089]"
          >
            <span className="grid h-full w-[56px] shrink-0 place-content-center">
              <Icon className="h-[18px] w-[18px]" aria-hidden />
            </span>
        ...
        <button
          ...
          className="flex h-10 w-full items-center rounded-xl text-[#7a6355] transition-colors hover:bg-[#E9F9FE]"
        >
          <span className="grid h-full w-[56px] shrink-0 place-content-center">
            <ChevronsRight
