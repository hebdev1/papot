...
const HOVER = {
  primary: { solid: "hover:bg-[#001b6e]", outline: "hover:bg-[#D6F0FB]", subtle: "hover:bg-[#d8f0fb]" },
  secondary: { solid: "hover:bg-[#2e1f18]", outline: "hover:bg-[#E9F9FE]", subtle: "hover:bg-[#eeddc6]" },
